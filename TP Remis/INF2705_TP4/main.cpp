...
void calculerPhysique( )
{
    ...
    if ( Etat::enmouvement )
    {
        ...
        glVertexAttribPointer( locpositionRetroaction  , 4, GL_FLOAT, GL_FALSE, sizeof(Particule), reinterpret_cast<void*>( offsetof(Particule,position) ) ); 
        glVertexAttribPointer( locvitesseRetroaction  , 4, GL_FLOAT, GL_FALSE, sizeof(Particule), reinterpret_cast<void*>( offsetof(Particule,vitesse) ) );
        glVertexAttribPointer( loctempsDeVieRestantRetroaction  , 4, GL_FLOAT, GL_FALSE, sizeof(Particule), reinterpret_cast<void*>( offsetof(Particule,tempsDeVieRestant) ) );
